...
if (!empty($_SESSION['active'])) {
  ...
  Debe ingresar el usuario y la clave!
      ...
      if ($resultado > 0) {
        ...
        $alert = '<div class="alert alert-danger" role="alert">
              Usuario y/o Contraseña Incorrecta! <br/>
			  Intente nueva vez.
            </div>';
        session_destroy();
      }
...
<body class="bg-gradient-primary" style="background-image: url('./fondo.JPG');">
      ...
      <div class="col-xl-10 col-lg-12 col-md-9"> 
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
			  <div class="col-lg-6 d-none d-lg-block bg-login-image" style="padding: 5em;">
                <img src="sistema/img/logo.PNG" class="img-thumbnail" style="widht: 500px; height: 300px;">
              </div> 
              <div class="col-lg-6">
                <div class="p-5"> 
